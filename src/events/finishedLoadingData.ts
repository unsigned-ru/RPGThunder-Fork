...
export async function onFinishedLoadingDataAndReady(this: any)
{
    ...
    !cf.DEVMODE ? new CronJob("0 */1 * * *", async function() {dbl.postStats(client.users.cache.size); console.log("Posting stats to top.gg");}, undefined, true, undefined, undefined, true) : undefined;
